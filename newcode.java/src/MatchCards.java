    ...
    public class MatchCards {
        ...
        String[] normalCardList ={ // NORMAL MODE (8 PAIRS)
    ...
    boardHeight = rows * cardHeight; 
        ...
        centerWrapper.setBackground(new Color(30, 30, 60)); // optional background color
        ...
        hintButton.setEnabled(false); // start disablled 0 coins 
